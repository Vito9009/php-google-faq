...
<?php
    $faq = [
        [
            "domanda" => "<div class=\"domanda\"><h2>Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?</h2></div>",
            "risposta" => "<div class=\"risposta\"><p>La recente <a href=\"#\"></a> decisione della Corte di giustizia dell'Unione europea ha profonde conseguenze per i motori di ricerca in Europa. La Corte ha stabilito che alcuni utenti hanno il diritto di chiedere ai motori di ricerca come Google di rimuovere risultati relativi a chiavi di ricerca che includono il proprio nome. Per poter essere rimossi, i risultati visualizzati devono essere inadeguati, irrilevanti o non più rilevanti, o eccessivi.</p>
        ...
        [
            "domanda" => "<div class=\"domanda\"><h2>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h2></div>",
            "risposta" => "<div class=\"risposta\"><p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>
            ...
            <p><a href=\"#\">Scopri</a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.</p></div>"
        ],
        [
            "domanda" => "<div class=\"domanda\"><h2>Perché il mio account è associato a un paese?</h2></div>",
            "risposta" => "<div class=\"risposta\"><p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
            <ol>
